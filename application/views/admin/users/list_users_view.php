	...
	<div class="row">
    		<div class="col-lg-12" style="margin-top: 10px;">
    			...
    			if(!empty($users))
    			{
      				...
      				echo '<tr><td>ID</td><td>Username</td></td><td>Name</td><td>Address</td><td>Birthday</td><td>Operations';
      				foreach($users as $user)
      				{
        				echo '<tr>';
        				echo '<td>'.$user->id.'</td><td>'.$user->username.'</td><td>'.$user->first_name.' '.$user->last_name.'</td></td><td>'.$user->address.'</td><td>'.$user->birthday.'</td><td>';
